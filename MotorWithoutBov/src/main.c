 ...
 *  Benjamin Legat
 *
 *  La version withoutBOV est encore un brin expérimentale :-)
 *  Si nécessaire, mettre des questions sur Teams :-)
 *  Là, cela marche chez moi : pas testé sur les autres plateformes.
 *  
 * ==========================================================================
 */
...
{  
    ...
    GLFWwindow* window = glfemInit("EPL1110 : Switched Reluctance Motor ");
...
//
        ...
        glfemReshapeWindows((femMesh*)theMotorMesh,w,h);
...
//
        ...
        if (theTime > theDiscreteTime) {
         ...
         //sprintf(theMessage, "Bande du calcul du couple");
